 ...
 * - When running on Netlify (moxie-dev.netlify.app), points to Render backend (https://moxie-0avp.onrender.com).
 */
...
export const BACKEND_URL = isLocalhost
  ...
  : (process.env.REACT_APP_BACKEND_URL || "https://moxie-0avp.onrender.com");
