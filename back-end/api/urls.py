...
urlpatterns = [
    ...
    path('customer/forgot-password/', CustomerForgotPasswordView.as_view(), name='customer-forgot-password'),
    path('auth/forgot-password/', CustomerForgotPasswordView.as_view(), name='auth-forgot-password'),
    path('customer/reset-password/', CustomerResetPasswordView.as_view(), name='customer-reset-password'),
    path('auth/reset-password/', CustomerResetPasswordView.as_view(), name='auth-reset-password'),
